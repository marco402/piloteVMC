...
enum MODES {RIEN = 0, ARRET, PETITE_VITESSE, GRANDE_VITESSE, AUTO, TEMPO_MARCHE_PV, TEMPO_MARCHE_GV, TEMPO_ARRET,ETE,HIVER,DERNIER};
...
enum MESSAGE_TYPE_3 { NOUV_MODE, FIN_MESSAGE_TYPE_3 };	//,PB_REC_CAN    infos affichage vers uc
//#ifdef ALARME
	enum MESSAGE_TYPE_4 { AFF_CUISINE_T_MSB = 0, AFF_CUISINE_T_LSB, AFF_CUISINE_H_MSB, AFF_CUISINE_H_LSB,ETAT_WIFI,LUMINOSITE_LEDS_RGB, ALARME_GARAGE, ALARME_PORTAIL, FIN_MESSAGE_TYPE_4 };					//capteurs  uc vers affichage
//#else
...
//#endif
//#ifdef TRAITMODE
enum MESSAGE_TYPE_5 { DUREE_FORCAGE_MSB, DUREE_FORCAGE_MIDDLE, DUREE_FORCAGE_LSB, CPT_DELAI_CGT_VITESSE, NB_MINUTE_JOUR_COURANT_MSB, NB_MINUTE_JOUR_COURANT_LSB, MARCHE_ARRET, FORCAGE_MODE, FIN_MESSAGE_TYPE_5 };   //traitement uc vers affichage
//#else
