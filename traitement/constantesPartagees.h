...
//              il faut le charger dans les 2 projets pour qu'il soit transf�r� dans le dossier de generation(user...)
...
enum MESSAGE_TYPE_5 { DECOMPTE_TEMPO_ARRET_MARCHE_FORCE_MSB, DECOMPTE_TEMPO_ARRET_MARCHE_FORCE_MIDDLE, DECOMPTE_TEMPO_ARRET_MARCHE_FORCE_LSB, CPT_DELAI_CGT_VITESSE, NB_MINUTE_JOUR_COURANT_MSB, NB_MINUTE_JOUR_COURANT_LSB,MARCHE_ARRET, FIN_MESSAGE_TYPE_5 };
