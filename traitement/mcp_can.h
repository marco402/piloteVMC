 ...
 *********************************************************************************************************/
   ...
   // marc INT8U mcp2515_readStatus(void);                                     // Read MCP2515 Status
...
public:
	INT8U mcp2515_readStatus(void);                                     // Read MCP2515 Status  marc
    MCP_CAN(INT8U _CS,uint32_t clockSPI);
    INT8U begin(INT8U idmodeset, INT8U speedset, INT8U clockset);       // Initialize controller parameters   //marc
